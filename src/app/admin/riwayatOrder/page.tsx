            ...
            {chartMode === 'single' ? (
              <div className="flex items-center gap-2">
                ...
                <input type="month" value={singleMonth} onChange={e => setSingleMonth(e.target.value)}
                  className="flex-1 sm:flex-none text-sm border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#1E562A]/20 focus:border-[#1E562A] transition-colors bg-white" />
              </div>
            ) : (
              <div className="space-y-2">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <input type="month" value={rangeFrom} onChange={e => setRangeFrom(e.target.value)} max={rangeTo}
                    className="flex-1 min-w-[130px] text-sm border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#1E562A]/20 focus:border-[#1E562A] transition-colors bg-white" />
